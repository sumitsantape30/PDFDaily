    ...
    <div style={{ backgroundColor: '#E9F1FA' }}>
      ...
      <div className="row">
        ...
        <div className="col-md-10 col-lg-6 col-xl-6 col-sm-10 col-10">
          <br />
          <h1 style={{ fontSize: '1.5rem' }}><b><center>Language Translation</center></b></h1>
          <br /><br />
          <div className="row">
            <div className="form-group col-xl-5 col-lg-5">
              <label htmlFor="lang1" style={{ marginRight: '10px' }}>From</label>
            ...
            <div className="form-group col-xl-5 col-lg-5" >
              <label htmlFor="lang2" style={{ marginRight: '10px' }}>To</label>
          ...
          <form method="POST">
            <div className="form-group" >
              ...
              {'\n'}
              <textarea name="text" className="form-control" style={{ border: '1px solid black' }} id="text" autoFocus={true} required></textarea>
            </div>
            ...
            <div>
              <div className="d-flex align-items-center justify-content-center">
                <button type="submit" className="btn btn-dark" style={{ borderRadius: '12px', width: '120px', height: '35px' }}>Translate</button>
              </div>
              <br>
              </br>
            </div>
            <p>Output Text</p>
            <div className="alert alert-light" style={{ border: '1px solid black' }}>
